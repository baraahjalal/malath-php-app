...
require_once ROOT_PATH . '/includes/notify.php';
...
$st = $pdo->prepare("SELECT pc.id, pc.content, pc.created_at, u.name, u.avatar FROM post_comments pc JOIN users u ON pc.user_id=u.id WHERE pc.id=?");
